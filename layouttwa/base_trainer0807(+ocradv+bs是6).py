...
from pythia.models.tap import M4C, TextBert, LayoutlmConfig
from pytorch_transformers.modeling_bert import (
    BertLayerNorm, BertEmbeddings, BertEncoder
)
from transformers import BertConfig, BertPreTrainedModel, BertModel, LayoutLMModel, ViTFeatureExtractor, ViTModel, logging
