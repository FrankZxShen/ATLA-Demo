...
from transformers import BertConfig, BertPreTrainedModel, BertModel, LayoutLMModel, ViTFeatureExtractor, ViTModel
...
class TextBert(LayoutLMModel):
    ...
    def forward(self, txt_inds, txt_mask, bbox=None, adv=False, txt_type_mask=None, adv_delta_txt=None):
