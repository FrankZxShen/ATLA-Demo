                ...
                with autocast(enabled=False):
                    ...
                    if batch['adv'] == True:
                        ...
                        if "textcls_scores" in list(model_output.keys()):
                            ...
                            # Pollute_CLS
                            # gt_pollutecls_scores = model_output["pollutecls_scores"] #[x,1]
                            # # print("3:",gt_pollutecls_scores.shape)
                            ...
                            #Overlap_CLS
                            # gt_overlapcls_scores = model_output["overlapcls_scores"] #[x,1]
                            # print("4:",gt_overlapcls_scores.shape)
