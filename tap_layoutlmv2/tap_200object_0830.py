...
class M4C(BaseModel):
    ...
    def _forward_obj_encoding(self, sample_list, fwd_results):
        ...
        # if torch.count_nonzero(sample_list.image).item() == 0:
        ...
        #     obj_fc7 = F.normalize(obj_fc7, dim=-1)#[x,300,2048]
        #     obj_feat = obj_fc7
        #     obj_mmt_in = (
        ...
        # obj_feat = F.interpolate(obj_feat.transpose(1,2),size=obj_bbox.size(1),mode='linear').transpose(1,2)
