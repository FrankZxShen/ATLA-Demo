...
class M4CTextVQADataset(TextVQADataset):
    ...
    def add_sample_details(self, sample_info, sample):
        ocr_str_len, obj_str_len = 150, 50
        # ocr_str_len, obj_str_len = 100, 100   ## oom on 16g

        #######################################################################
        # 0. Load img
        file = self.config.image_features.train_images[0]
        # file2 = self.config.image_features.train_images[1]
        # img_path=None
        img_path = 'data/'+ file + '/' + sample.image_id + '.jpg'
        # if os.path.exists(img_name):
        #     img_path = img_name
        # img_name = 'data/'+ file2 + '/' + 'coco-text/' + sample.image_id + '.jpg'
        # if os.path.exists(img_name):
        #     img_path = img_name
        # img_name = 'data/'+ file2 + '/' + 'icdar/' + sample.image_id + '.jpg'
        # if os.path.exists(img_name):
        #     img_path = img_name
        # img_name = 'data/'+ file2 + '/' + 'IIIT_text/' + sample.image_id + '.jpg'
        # if os.path.exists(img_name):
        #     img_path = img_name
        # img_name = 'data/'+ file2 + '/' + 'imageNet/' + sample.image_id + '.JPEG'
        # if os.path.exists(img_name):
        #     img_path = img_name
        # img_name = 'data/'+ file2 + '/' + 'VisualGenome/1/' + sample.image_id + '.jpg'
        # if os.path.exists(img_name):
        #     img_path = img_name
        # img_name = 'data/'+ file2 + '/' + 'VisualGenome/2/' + sample.image_id + '.jpg'
        # if os.path.exists(img_name):
        #     img_path = img_name
        # img_name = 'data/'+ file2 + '/' + 'vizwiz/' + sample.image_id + '.jpg'
        # if os.path.exists(img_name):
        #     img_path = img_name
